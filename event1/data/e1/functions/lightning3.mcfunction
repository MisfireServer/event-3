...
schedule function e1:lightboom 7t
schedule function e1:lightgone 10t
schedule function e1:sound 3s
schedule function e1:sound 2s
schedule function e1:sound 4s
schedule function e1:sound 5s
schedule function e1:watcherspeak 2s
